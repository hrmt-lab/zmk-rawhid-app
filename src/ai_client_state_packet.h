...
/* Decodes a 6, 7, 8 or 9 byte AI_CLIENT_STATE payload.
 *
 ...
 * itself. 6 and 7 byte payloads always resolve to slot 0. The ninth byte
 * defaults to NORMAL for every older form. */
enum rawhid_app_ai_client_decode_result
